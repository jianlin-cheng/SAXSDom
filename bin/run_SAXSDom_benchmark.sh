...
perl $GLOBAL_PATH/scripts/run_SAXSdom_benchmark_parallel.pl $targetid $outputdir/seq.fasta $outputdir/seq.dat  $outputdir/domainlist  $outputdir $epoch $outputdir/native.pdb $ncpu 2>&1 | tee $outputdir/run.log
