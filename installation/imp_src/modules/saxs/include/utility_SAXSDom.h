...
#ifndef IMPSAXS_UTILITY_SAXS_JIE_H
#define IMPSAXS_UTILITY_SAXS_JIE_H
...
//! read pdb files
IMPSAXSEXPORT
void read_pdb_saxs(const std::string file,
              std::vector<std::string>& pdb_file_names, std::string inputString,
              std::vector<IMP::Particles>& particles_vec,
              bool residue_level = false,
              bool heavy_atoms_only = true,
              int multi_model_pdb = 2);
...
#endif /* IMPSAXS_UTILITY_SAXS_JIE_H */
