...
#ifndef IMPATOM_PDB_SAXS_JIE_H
#define IMPATOM_PDB_SAXS_JIE_H
 ...
 */
IMPATOMEXPORT Hierarchy
    read_pdb_saxs(TextInput input, Model *model, std::string inputString,
             PDBSelector *selector = get_default_pdb_selector(),
             bool select_first_model = true
#ifndef IMP_DOXYGEN
             ,
...
// added by jie 11/21/2016
IMPATOMEXPORT void read_pdb_SAXS(TextInput input, int model, std::string inputString, Hierarchy h);
