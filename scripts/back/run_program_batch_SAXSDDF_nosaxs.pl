...
for($epoch =$epoch_start; $epoch<=$epoch_end;$epoch++)
{
  ...
  print OUT "/storage/htc/bdm/jh7x3/DomainOrientation_project/SAXSDom/bin/run_SAXSDom_abinitio_withNative.sh SASDDF9 /data/jh7x3/SAXS_fold_project/SASDDF9/SASDDF9.fasta  /data/jh7x3/SAXS_fold_project/SASDDF9/SASDDF9.dat /data/jh7x3/SAXS_fold_project/SASDDF9/domain_models/domain_pdb_list  $outputdir/epoch$epoch  ' -t -g test_assembly  -d 1 -x 1' 1 /data/jh7x3/SAXS_fold_project/SASDDF9/SASDDF9_native.pdb\n";
